...
exo__Asset_updatedAt: 2026-08-06T15:43:28
exo__Instance_class:
...
exo__AssetSpace descriptor for `kitelev/exoas-shared-identities` (EKA registry, D18 dependsOn). Holds foundational shared-identity TBox + concept classes (concept/lit/ztlk metaclasses, e.g. `lit__WebPage`) referenced by leaf ABox. dependsOn `exoas-public` (its concept-instances use public concept TBox). Mount path `assetspaces/kitelev/exoas-shared-identities/`.
